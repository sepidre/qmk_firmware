...
#define LAYOUT_ffkb_base( \
  ...
  LAYOUT_wrapper( \
        ...
        KC_MS_BTN1,      K11,      K12,      K13,      K14,      K15,      K16,      K17,      K18,      K19,      K1A,      KC_MS_BTN1, \
        KC_MS_BTN2,      K21,      K22,      K23,      K24,      K25,      K26,      K27,      K28,      K29,      K2A,      KC_MS_BTN2, \
                               KC_MUTE,      K33,      K34,      K35,      K36,      K37,      K38,      K39 \
    )
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_GME] = LAYOUT_ffkb_base_wrapper(
        ____________________GAME_L1___________________, ____________________NEO2_R1___________________,
        ...
        ____________________GAME_L3___________________, ____________________NEO2_R3___________________,
                     _______, KC_TAB, KC_SPC, MO(_WPN), KC_LALT, KC_ENT, MO(_FUNCTION), _______
    ),
    ...
    [_MOUSE] = LAYOUT_wrapper(
        _______, __________________MOUSE_4__________________, __________________MOUSE_1__________________, _______,
        _______, __________________MOUSE_4__________________, __________________MOUSE_2__________________, _______,
        _______, __________________MOUSE_4__________________, __________________MOUSE_3__________________, _______,
