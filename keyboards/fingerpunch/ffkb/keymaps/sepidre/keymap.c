...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_WPN] = LAYOUT_wrapper(
        _______, ________________WEAPON_1_______________, _____________________BLANK____________________, _______,
        _______, ________________WEAPON_2_______________, _____________________BLANK____________________, _______,
        _______, ________________WEAPON_3_______________, _____________________BLANK____________________, _______,
