...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_NEO2] = LAYOUT_ffkb_base_wrapper(
        _______, ____________________NEO2_L1___________________, ____________________NEO2_R1___________________, _______,
        _______, ____________________NEO2_L2___________________, ____________________NEO2_R2___________________, _______,
        _______, ____________________NEO2_L3___________________, ____________________NEO2_R3___________________, _______,
                                        __ALPHA_THUMBS_LEFT_3__, __ALPHA_THUMBS_RIGHT_3__
    ),

    [_APTv3] = LAYOUT_ffkb_base_wrapper(
        _______, __________________APTv3_L1____________________, __________________APTv3_R1____________________, _______,
        _______, __________________APTv3_L2____________________, __________________APTv3_R2____________________, _______,
        _______, __________________APTv3_L3____________________, __________________APTv3_R3____________________, _______,
                                        __ALPHA_THUMBS_LEFT_3__, __ALPHA_THUMBS_RIGHT_3__
    ),
